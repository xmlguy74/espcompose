...
export interface I2cProps extends _CoreComponent {
     ...
     */
    sdaPullupEnabled?: boolean | EmbedValue<boolean>;
     ...
     */
    sclPullupEnabled?: boolean | EmbedValue<boolean>;
    ...
    scan?: boolean | EmbedValue<boolean>;
    /**
     ...
     */
    lowPowerMode?: boolean | EmbedValue<boolean>;
}
declare global {
    namespace JSX {
