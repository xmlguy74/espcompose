...
export interface Esp32BleServerServicesPropsCharacteristicsPropsDescriptorsProps {
    uuid: number;
    read?: boolean | EmbedValue<boolean>;
    write?: boolean | EmbedValue<boolean>;
    /** @yamlKey on_write */
...
export interface Esp32BleServerServicesPropsCharacteristicsProps {
    ...
    broadcast?: boolean | EmbedValue<boolean>;
    indicate?: boolean | EmbedValue<boolean>;
    /** @yamlKey write_no_response */
    writeNoResponse?: boolean | EmbedValue<boolean>;
}
export interface Esp32BleServerServicesProps {
    uuid: number;
    advertise?: boolean | EmbedValue<boolean>;
...
export interface Esp32BleServerProps extends _CoreComponent {
    ...
    appearance?: number | EmbedValue<number>;
     ...
     * @yamlKey max_clients
     */
    maxClients?: number | EmbedValue<number>;
